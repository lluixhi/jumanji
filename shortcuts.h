 ...
 * @return true if no error occured otherwise false
 */
bool sc_restore(girara_session_t* session, girara_argument_t* argument, unsigned int t);
 ...
 * @return true if no error occured otherwise false
 */
bool sc_toggle_bookmark(girara_session_t* session, girara_argument_t* argument, unsigned int t);
